...
always-on prefix (this body loads only when the skill fires). Use a shape **when the
deliverable is one of the three below** — they make a weak model's answer complete and a strong model's
